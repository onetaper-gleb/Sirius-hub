        ...
        for user_data in firebase_and_db_users:
            ...
            try:
                try:
                    ...
                    print(
                        f"Пользователь {user_data['email']} уже существует в Firebase"
                    )
                    ...
                    created_count += 1
                    print(
                        f"Создан пользователь в Firebase: {user_data['email']} (UID: {user.uid})"
                    )
            ...
            if firebase_uid:
                ...
                session.add(user)
                print(
                    f"Добавлен пользователь в БД: {user_data['email']} с ролью {user_data['role']}"
                )
